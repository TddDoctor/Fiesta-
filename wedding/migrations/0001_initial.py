    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bride', models.CharField(max_length=255, verbose_name='Bride Names')),
                ('gloom', models.CharField(max_length=255, verbose_name='Gloom Names')),
                ('slug', models.SlugField(unique=True)),
                ...
                ('difficulty', models.SmallIntegerField(default=2, verbose_name='Difficulty', choices=[(1, 'Give Away'), (2, 'Introduction'), (3, 'Wedding'), (4, 'Jubile')])),
                ('date_created', models.DateTimeField(editable=False)),
                ('date_updated', models.DateTimeField(editable=False)),
                ('author', models.ForeignKey(verbose_name='Author', to=settings.AUTH_USER_MODEL)),
                ('category', models.ManyToManyField(to='wedding.Category', verbose_name='Categories')),
            ],
            options={
